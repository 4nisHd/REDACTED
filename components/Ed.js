    ...
    return (
        <div id="honors" className="mt-4 text-white">
            ...
            <div className="flex flex-col md:flex-row mt-4 gap-5">
                ...
                <EdCard name="National School of Computer Science" issued="Computer Science Engineering Degree" desc="Generalized computer science, software engineering and applied mathematics." />
            </div>
