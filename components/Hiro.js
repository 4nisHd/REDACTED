...
/>
            ...
            <div className='md:w-3/6' data-aos="fade-right" data-aos-duration="1000" data-aos-offset="100" >
                <div className="flex flex-col w-full mt-8">
                    ...
                    <p className="text-md font-light text-gray-400 ">A second year computer science engineering student with a passion for solving complex challenges, with out-ofthe-box thinking and strong analytical skills. Interested in emerging technologies, especially Artificial
